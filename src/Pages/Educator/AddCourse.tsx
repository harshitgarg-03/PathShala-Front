import crossicon from '../../Data/cross_icon.svg'
  ...
  <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
    ...
    <div className="bg-white w-full max-w-3xl rounded-2xl shadow-xl max-h-[90vh] no-scrollbar overflow-y-auto">
      ...
      <div className="flex justify-end gap-4 px-8 py-6 border-t">
        <button className="px-6 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 cursor-pointer transition"
          onClick={() => navigate("/Educator/Dashboard")}
        >
          Cancel
        </button>
        <button className="px-6 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition cursor-pointer shadow"
