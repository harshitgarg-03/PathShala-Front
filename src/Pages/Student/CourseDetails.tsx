...
function CourseDetails() {
  ...
  const getenrolled = CourseStore((s) => s.GetEnrolledCourse);
  const enrollcoursese = CourseStore(s => s.enrollCourse);
  ...
  const isEnroll = enrollcoursese?.includes(id!);
  ...
  useEffect(() => {
    const gettingEntoll = async () => {
      await getenrolled();
      // console.log("data is ", enrollcoursese);
    };
    gettingEntoll();
  }, [getenrolled]);
